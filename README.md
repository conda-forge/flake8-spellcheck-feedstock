...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-spellcheck-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14437&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-spellcheck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-spellcheck` can be installed with:

```
conda install flake8-spellcheck
```

It is possible to list all of the versions of `flake8-spellcheck` available on your platform with:
